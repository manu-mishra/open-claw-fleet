...
push_image "fleet-manager" "open-claw-fleet/fleet-manager"
push_image "command-center" "open-claw-fleet/command-center"
...
echo "  $ECR_REGISTRY/open-claw-fleet/fleet-manager:$VERSION"
echo "  $ECR_REGISTRY/open-claw-fleet/command-center:$VERSION"
